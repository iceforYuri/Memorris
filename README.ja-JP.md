...
- グループ化、スクロール追跡、KaTeX 数式見出し対応

![TOC プレビュー](./image/README/1781607282363.png)

### パフォーマンス

- 画像の遅延読み込み、主要コンポーネントの最適化

### アーカイブページ

- タグクラウド、カウントアニメーション、カテゴリ既定展開

<p align="center">
  <img src="./image/README/1781607819957.png" alt="タグクラウド" width="49%" />
  <img src="./image/README/1781607863903.png" alt="カテゴリページ" width="49%" />
</p>
